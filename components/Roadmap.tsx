...
function Roadmap() {
  return (
    <div id='roadmap' className="md:w-[90vw] flex flex-col fold_chrono justify-center items-center">
      ...
      <div className="md:my-12 md:w-[80%] w-[100%] mt-12">
        ...
        >
          ...
          <div className="md:text-4xl text-xl mr-auto flex justify-start font-medium my-4 text-[#F1B170]">Email</div>
            <div className="md:text-base text-sm text-left text-white">Keep yourself up to date by checking your registered email on the regular. (Sneak a peek in the spam folder too)</div>
          </div>

          <div className="">
            <div className="md:text-4xl text-xl ml-auto flex justify-end font-medium my-4 text-[#5ACEF2]">Tests/Tasks</div>
            <div className="md:text-base text-sm text-right text-white">Let the fire in you be kindled. Showcase your talent through tests or tasks to make your mark among the competitors.</div>
          </div>

          <div className="">
            <div className="md:text-4xl text-xl mr-auto flex justify-start font-medium my-4 text-[#FF8062]">Interviews</div>
            <div className="md:text-base text-sm text-left text-white">You are just one step away. Keep calm and get ready for a small, casual interview.</div>
          </div>

          <div className="">
            <div className="md:text-4xl text-xl ml-auto flex justify-end font-medium my-4 text-[#F1B170]">Welcome</div>
            <div className="md:text-base text-sm text-right text-white">Look at that! You are now officially a part of the Alexa Developers SRM family. Much surprises await on the other side!</div>
          </div>
